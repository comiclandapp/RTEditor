...
final class JavaScriptManager {
    ...
    @MainActor private func evaluateWaitingFunctions() {
    ...
    @MainActor private func evaluateWhenDOMIsReady(function: JavaScriptFunction) {
        guard isDOMContentLoaded else {
    ...
    @MainActor private func evaluate(function: JavaScriptFunction) {
